...
class XPS:
	...
	def InstallerVersionGet (self, socketId):
		if (XPS.__usedSockets[socketId] == 0):
			return
	...
	def ISRCorrectorCompensateOverrunNumberGet (self, socketId):
		if (XPS.__usedSockets[socketId] == 0):
			return
	...
	def ISRCorrectorCompensateOverrunNumberReset (self, socketId):
		if (XPS.__usedSockets[socketId] == 0):
			return
